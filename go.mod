module github.com/demdxx/redify

go 1.17

require (
	github.com/ReneKroon/ttlcache/v2 v2.9.0
	github.com/demdxx/gocast v1.0.2-0.20211024165513-49ecad3c56ee
...
replace github.com/driftprogramming/pgxpoolmock => github.com/demdxx/pgxpoolmock v1.1.1-0.20211027111540-26ddce2c5601
